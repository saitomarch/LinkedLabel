#
#  Be sure to run `pod spec lint LinkedLabel.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "SAITO Tomomi"
  # spec.authors            = { "SAITO Tomomi" => "t-saito@project-flora.net" }
  # spec.social_media_url   = "https://twitter.com/SAITO Tomomi"
